...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener, LabWorkAdd.OnUiUpdate
{
    // Fragment容器，用來滑動切換畫面
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // 初始化側邊欄ListView選項
        listView.setAdapter(new com.fctm.actionbartabdrawer.DrawerItemAdapter(this));
    ...
    {
        LabHelRpt frag = (LabHelRpt)sectionsPagerAdapter.getItem(1);
