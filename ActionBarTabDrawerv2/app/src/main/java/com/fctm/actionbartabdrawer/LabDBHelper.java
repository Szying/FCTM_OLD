...
public class LabDBHelper
{
    ...
    public LabDBHelper(Context context)
    {
        ...
        helper = new DBHelper(context, "Labfile", null, 3);
    }
    ...
    public void add(String blood_glucose, String blood_pressure,String palpitant,String pulse ,String datetime)
    {
        // 取出資料庫物件, 並且是可以寫入狀態
        // 當APP空間不夠時, 該方法會丟出例外
    ...
    public LabData get(String datetime)
    {
        ...
        // 執行查詢
        Cursor c = db.query("labs", new String[]{"_id, blood_glucose, blood_pressure,palpitant,pulse, datetime"},
    ...
    public ArrayList<LabData> getAllData()
    {
        ...
        // 透過query來查詢資料
        Cursor c = db.query("labs",                           // 資料表名字 
                new String[]{"_id", "blood_glucose", "blood_pressure","palpitant","pulse", "datetime"},  // 要取出的欄位資料
                null,                                        // 查詢條件式 
                null,                                        // 查詢條件值字串陣列
                null,                                        // Group By字串語法 
                null,                                        // Having字串法 
