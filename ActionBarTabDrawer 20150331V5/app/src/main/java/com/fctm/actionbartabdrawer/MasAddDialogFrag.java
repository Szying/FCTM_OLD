        ...
        imgbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (everyday.getText().toString() == "" | show2.getText().toString() == "" || show3.getText().toString() == "" || tmespin.getText().toString() == "") {
                    ...
                    masDB.add(everyday.getText().toString(), show2.getText().toString(), show3.getText().toString(), tmespin.getText().toString(),"NEW",memberid);
                    ...
                    url1=url1+show2.getText().toString()+"`"+show3.getText().toString()+"`"+tmespin.getText().toString()+"`"+"NEW"+"`"+memberid;
                    try{
                       // Toast.makeText(view.getContext(),url1 , Toast.LENGTH_SHORT).show();
                        HttpAction.insert("schdul",encode(url1),MasAddDialogFrag.this);
                       // HttpAction.delete("health","001",MasAddDialogFrag.this);
                    }catch (Exception e){
