        ...
        LabAddDialogFrag.OnUiUpdate,MasAddDialogFrag.OnUiUpdateMas
{
 ...
 //       sectionsPagerAdapterMas = new SectionsPagerAdapterMas(getSupportFragmentManager());
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {    //Ann 新增
          ...
          //  DataAnysMode_MOD_SCHDUL=0;
            URLMode=1;
            HttpAction.query("schdul",MemberInfo.number, "NEW", MainActivity.this,"schedul");
            Toast.makeText(this, "同步資料開始...會員帳號： "+MemberInfo.number
    ...
    public void doNotify(String result) {
        ...
        try {
           String decodresult=URLDecoder.decode(result, "Big-5");
    ...
    {
        return (MemberInfo)sectionsPagerAdapterMas.getItem(5);
    }
}
