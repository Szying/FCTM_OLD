...
public class InterNetConnect extends Fragment implements IHttpCompleted {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ImageButton btnadd = (ImageButton) getActivity().findViewById(R.id.imgbtnintercon);
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String memberid = "001";
                //從外部SERVER 取回資料
                String url1 = memberid;
                try {

                    HttpAction.query("schdul", "001", "NEW", InterNetConnect.this);
                    Toast.makeText(getActivity(), "InterNetConnect "+memberid, Toast.LENGTH_SHORT).show();
                    //http://52.11.214.88:8080/4/schedul?action=query&type=schdul&data1=001
